<!-- GET방식으로 전달 -->
<!-- http://localhost:8080/Test/Practice_21/Practice_21-1/result.jsp?type=%ED%95%99%EB%B6%80%EC%83%9D&strID=kim&strPwd=1000-->
<!-- 한글이 깨져보일경우: 보내는 파라미터 값을 encodeURI(값,"UTF-8")을 통해 직접 인코딩시켜 보낸다.->
...
<body>
<div align = "center">
<form name="frm1" method = GET action = result.jsp>
