...
<body>
<div align = "center">
<form name="member" method = post action = Practice_40.jsp>
<img src="image/eclass_title.jpg">
	...
	<tr>
		<th>국적</th>
		<td>
			<input type = "text" value = "대한민국" size = "25" readonly>
	...
	<tr>
		<th>가입인사</th>
		<td><textarea rows = 5 cols = 55 name="memo">회원들에게 간단한 가입인사를 남겨주세요</textarea></td>
	</tr>
	<tr>
		<th>증명사진</th>
		<td><input type = "file" value = "파일선택"></td>
	</tr>
	<tr>
